...
### Option 1: Clone and copy to your skills directory
```bash
...
### Option 2: Import individual `.skill` files
Download a skill folder, zip it as `<skill-name>.skill`, and import it into Claude Code via the skills panel.
